...
public class Store3 {
    ...
    private void getMobile1() {
        ...
        Mobile mobile = new Mobile(model, processor, ram, storage, 199.99);
    ...
    public static void getMobile2() {
        ...
        System.out.println("You've selected a Mobile!");
        Mobile mobile = new Mobile(model, processor, ram, storage, 99.99);
        double totalPrice = mobile.getPrice1();
    ...
    public static void getMobile3() {
        ...
        System.out.println("You've selected a Mobile!");
        Mobile mobile = new Mobile(model, processor, ram, storage, 139.99);
        double totalPrice = mobile.getPrice1();
